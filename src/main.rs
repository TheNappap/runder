...
fn default_scene(settings: Arc<Settings>) -> SceneGraph{
    ...
    scene_graph.add_object(Box::new(Rectangle::unit_square(Transformation::new().scale_all(4.0).rotate(RotationAxis::Xaxis, -FRAC_PI_2).translate(Vector::new(0.0,-1.0,6.0)), true,Box::new(Lambertian::new(Color::gray(1.0))) )));
