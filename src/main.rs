...
fn default_scene(settings: Arc<Settings>) -> SceneGraph{
    ...
    //scene_graph.add_object(Box::new(Triangle::new([Point::new(1.0,1.0,0.0),Point::new(-1.0,1.0,0.0),Point::new(-1.0,5.0,2.0)], true,Transformation::new(),Box::new(Lambertian::new(Color::gray(1.0))) )));
